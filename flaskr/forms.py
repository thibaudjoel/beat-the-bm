...
class ModelForm(FlaskForm):
    ...
    number_of_last_games = IntegerField(
        "Number of last games considered for prediction", validators=[InputRequired()]
    )
    modeltype = QuerySelectField(
        query_factory=query_all_modeltypes,
        get_label="name",
        validators=[InputRequired()],
    )
    features = QuerySelectMultipleField(
        query_factory=query_all_features, get_label="name", validators=[InputRequired()]
    )
    seasons = QuerySelectMultipleField(
        query_factory=query_all_seasons,
        get_label="start_date",
        validators=[InputRequired()],
    )
